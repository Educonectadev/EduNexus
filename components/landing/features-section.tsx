...
const features = [
  {
    ...
    description: "Control total del proceso educativo: desde el diseño curricular hasta la emisión de libretas de notas. Cálculo automático de promedios, escalas de calificación y generación de boletines según las normas del MINEDU.",
    visual: "academic",
  },
  {
    number: "02",
    title: "Matrícula y Administración",
    description: "Automatiza todo el ciclo de matrícula: inscripción, validación de documentos, asignación de cursos, generación de kardex y seguimiento del historial académico de cada estudiante.",
    visual: "admin",
  },
  {
    number: "03",
    title: "Comunicación Unificada",
    description: "Conecta directivos, docentes, padres de familia y estudiantes. Notificaciones en tiempo real, mensajería interna, circulares digitales y portal de padres con acceso 24/7.",
    visual: "communication",
  },
  {
    number: "04",
    title: "Finanzas y Tesorería",
    description: "Gestión completa de pensiones, cuotas escolares, becas y subsidios. Integración con SUNAT para facturación electrónica, conciliación bancaria automática y reportes financieros al MINEDU.",
    visual: "finance",
  },
];
