...
const reporte = await escuela.reportes.generar({
  tipo: 'libreta-notas',
  periodo: '2024-1',
  formato: 'pdf'
})`,
...
const features = [
  { 
    ...
    description: "Acceso programático a todos los módulos del sistema."
  },
  { 
    title: "Webhooks en tiempo real", 
    description: "Eventos push para notificaciones instantáneas."
  },
  { 
    title: "SDK en múltiples lenguajes", 
    description: "Librerías oficiales para JavaScript, Python y PHP."
  },
  { 
    title: "Documentación interactiva", 
    description: "Prueba los endpoints en vivo desde la consola."
  },
];
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-start">
          ...
          >
            ...
            <h2 className="text-4xl lg:text-6xl font-display tracking-tight mb-8">
              Construido por devs.
              <br />
              <span className="text-muted-foreground">Para la educación.</span>
            </h2>
