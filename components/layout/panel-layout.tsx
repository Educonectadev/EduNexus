    ...
    <div className="flex h-screen overflow-hidden text-[var(--sb-on-background)]" data-role={role} style={{ background: "#f5f5f5" }}>
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <main className={cn(
          ...
          pathname.startsWith("/docente/") ? "p-1.5 h-full [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none] bg-[#f5f5f5] dark:bg-black" : "px-6 pb-32 md:pb-6 bg-[#f5f5f5] dark:bg-black"
        )}>
