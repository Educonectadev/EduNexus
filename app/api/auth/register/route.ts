...
export async function POST(req: NextRequest) {
  try {
    ...
    const { institutionId, code } = await createFreeInstitution({
      ...
      totalTeachers: totalTeachers ? Number(totalTeachers) : undefined,
      totalClassrooms: totalClassrooms ? Number(totalClassrooms) : undefined,
      hasLab: !!hasLab,
      hasLibrary: !!hasLibrary,
      hasComputerRoom: !!hasComputerRoom,
