            ...
            <motion.div
              ...
              {fichaLoading ? (
                <div className="p-10 flex flex-col items-center gap-3">
                  <div className="h-8 w-8 border-2 border-[#E5E5E5] dark:border-[#E5E5E5] border-t-[#000] dark:border-t-[#f4f4f5] rounded-full animate-spin" />
                ...
                <div>
                  <button onClick={() => setFichaOpen(false)}
                    className="absolute right-3 top-3 h-8 w-8 rounded-[14px] flex items-center justify-center bg-[#F5F5F5] dark:bg-[#27272a] text-[#666] dark:text-[#a1a1aa] hover:text-[#000] dark:text-[#f4f4f5] transition-colors z-10">
                    <X className="h-4 w-4" />
                  </button>
                              ...
                              <div className="flex gap-1 shrink-0">
                                ...
                                {p.phone && (
                                  <a href={`tel:${p.phone}`} title="Llamar"
                                    className="h-8 w-8 rounded-[14px] flex items-center justify-center bg-[#E5E5E5] dark:bg-[#3f3f46] text-[#666] dark:text-[#a1a1aa] hover:text-[#000] dark:text-[#f4f4f5] transition-colors">
